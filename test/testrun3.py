...
net = ViT((32, 32), (2, 2), 16, 10, img_channel=3, dev=dev, heads_num=4, msa_num=6).to(dev)
loss = torch.nn.CrossEntropyLoss()
opt = torch.optim.Adam(net.parameters(), lr=3e-4)
#logger = ViT_Logger("save/ViT_With_Test", net, 20210805180806)
logger = ViT_Logger("save/ViT", net)
